...
<div class="panel col-lg-12 moduleconfig-content">
    ...
    <div class="panel col-lg-3 moduleconfig-content">
      ...
      <ul class="list-group">
        <li class="list-group-item">
          <a class="btn " href="{$form_action_url}&PRESTATHEMA_ACTION=fake_customers_form">
            <i class="material-icons">person_add</i> 
            {l s='Fake Customers' mod='prestacollege'}
          </a>
        </li>
        <li class="list-group-item">
          <a class="btn " href="{$form_action_url}&PRESTATHEMA_ACTION=fake_carts_form">
            <i class="material-icons">add_shopping_cart</i> 
            {l s='Fake Carts' mod='prestacollege'}
          </a>
        </li>
        <li class="list-group-item">
          <a class="btn " href="{$form_action_url}&PRESTATHEMA_ACTION=fake_connections_form">
    ...
    <div class="panel col-lg-3 col-lg-offset-1 moduleconfig-content">
      ...
      <ul class="list-group">
        <li class="list-group-item">
          <a class="btn " href="{$form_action_url}&PRESTATHEMA_ACTION=loaddbjamandosnapshot" title="">
    ...
    <div class="panel col-lg-3  col-lg-offset-1 moduleconfig-content">
      ...
      <ul class="list-group">
        <li class="list-group-item">
          <a class="btn " href="{$form_action_url}&PRESTATHEMA_ACTION=administer_dbsnapshots">
            <i class="material-icons">note_add</i> 
            {l s='Administer Database Snapshots' mod='prestacollege'}</a>
        </li>
        <li class="list-group-item">
          <a class="btn " href="{$form_action_url}&PRESTATHEMA_ACTION=administer_filesnapshots">
