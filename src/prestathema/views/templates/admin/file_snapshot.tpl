<div class="panel col-lg-12 moduleconfig-content">
  ...
  <div class="row text-right">
    <a class="btn btn-primary" href="{$form_action_url}&PRESTATHEMA_ACTION=createfilesnapshot" title="">
      <i class="material-icons">note_add</i>
      {l s='Create file snapshot' mod='prestacollege'}
    </a>
    <a class="btn btn-primary" href="{$form_action_url}&PRESTATHEMA_ACTION=uploadfilesnapshotselect" title="">
