  ...
  <div class="row">
    <form id="curlsnapshotform" class="defaultForm form-horizontal"  action="{$form_action_url}" method="post" enctype="multipart/form-data" novalidate="">
      ...
      <input type="hidden" name="PRESTATHEMA_ACTION" value="curl{$curlaction}snapshot">
      <div class="row">
  ...
  <div class="row">
    <form id="uploadsnapshotform" class="defaultForm form-horizontal"  action="{$form_action_url}&PRESTATHEMA_ACTION=upload{$curlaction}snapshot" method="post" enctype="multipart/form-data" novalidate="">
      <input type="hidden" name="submitPrestaCollegeModule" value="1">
      <input type="hidden" name="PRESTATHEMA_ACTION" value="upload{$curlaction}snapshot">
      <div class="row">
