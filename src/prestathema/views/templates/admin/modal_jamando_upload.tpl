      ...
      {/if}
        <tr>
          ...
          <td class='col-lg-2'>
            {if isset($jd->snapshot_db_url)}
            <p>
              <a href="{$form_action_url}&PRESTATHEMA_ACTION=curljamandosnapshot&project={$jd->project}&build={$jd->buildnumber}&curldb=1" title="">
            ...
            {if isset($jd->snapshot_files_url)}
            <p>
              <a href="{$form_action_url}&PRESTATHEMA_ACTION=curljamandosnapshot&project={$jd->project}&build={$jd->buildnumber}&curlfile=1" title="">
            ...
            <p>
              <a href="{$form_action_url}&PRESTATHEMA_ACTION=curljamandosnapshot&project={$jd->project}&build={$jd->buildnumber}" title="">
