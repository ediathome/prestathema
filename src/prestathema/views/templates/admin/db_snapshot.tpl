<div class="panel col-lg-12 moduleconfig-content">
  ...
  <div class="row">
    ...
    <div class="row text-right">
      <a class="btn btn-primary" href="{$form_action_url}&PRESTATHEMA_ACTION=createdbsnapshot" title="">
        <i class="material-icons">note_add</i>
        {l s='Create database snapshot' mod='prestacollege'}
      </a>
      <a class="btn btn-primary" href="{$form_action_url}&PRESTATHEMA_ACTION=uploaddbsnapshotselect" title="">
